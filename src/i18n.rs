...
pub const PT_BR: Lang = Lang {
    ...
    help_game: "[Espaço/Clique] dedar  [Clique/1-0] comprar  [Shift] x10  [Alt/Bot.Dir.] max  [-/+] zoom\n[u] melhorias  [p] prestígio  [s] stats  [a] conquistas  [g] pegar dourado/bônus  [q] sair",
